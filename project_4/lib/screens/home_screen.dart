                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                onTap: () {
                                  print(
                                      "Navigating to CategoryPage with categoryId: ${category.categoryID}");
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
...
Widget _buildImageWithDetails(
    {required String imagePath, required String name, required String price}) {
  return Column(
...
class CustomSearchDelegate extends SearchDelegate {
  ...
  Widget buildSuggestions(BuildContext context) {
    final suggestions = ['Gucci', 'Balenciaga', 'Acme De La Vie'];
